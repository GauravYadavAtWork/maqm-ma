...
const Security = [Math.max(md8[0],md9[0]) , Math.max(md8[1],md9[1]) , Math.max(md8[2],md9[2])];

const Customization_new = [Math.max(md10[0],Math.max(md11[0],Math.max(md12[0] , md13[0]))) , Math.max(md10[1],Math.max(md11[1],Math.max(md12[1] , md13[1]))) , Math.max(md10[2],Math.max(md11[2],Math.max(md12[2] , md13[2])))];

const Time_Behavior = [Math.max(md14[0],md15[0]) , Math.max(md14[1],md15[1]) , Math.max(md14[2],md15[2])];

const Resource_Behavior = [Math.max(md16[0],Math.max(md17[0],Math.max(md18[0] ,Math.max(md19[0], md20[0]) ))) , Math.max(md16[1],Math.max(md17[1],Math.max(md18[1] ,Math.max(md19[1], md20[1]) ))) , Math.max(md16[2],Math.max(md17[2],Math.max(md18[2] ,Math.max(md19[2], md20[2]) )))];

const Efficiency_Compliance = [md21[0] , md21[1] , md21[2]];

const scalability = [Math.max(md22[0],Math.max(md23[0],md24[0])) , Math.max(md22[1],Math.max(md23[1],md24[1])) , Math.max(md22[2],Math.max(md23[2],md24[2]))];

const Performance = [Math.max(md25[0],md26[0]) , Math.max(md25[1],md26[1]) , Math.max(md25[2],md26[2])];

const Data_availability_new = [Math.max(md27[0],Math.max(md28[0],md29[0])) , Math.max(md27[1],Math.max(md28[1],md29[1])) , Math.max(md27[2],Math.max(md28[2],md29[2]))];

const Replace_ability = [md30[0] , md30[1] , md30[2]];

const Adaptability = [md31[0] , md31[1] , md31[2]];

const Install_ability = [md32[0] , md32[1] , md32[2]];

const Co_existence = [md33[0] , md33[1] , md33[2]];

const Portability_compliance = [md34[0] , md34[1] , md34[2]];

const Analyzability = [Math.max(md35[0],Math.max(md36[0],Math.max(md37[0] ,Math.max(md38[0], md39[0]) ))) , Math.max(md35[1],Math.max(md36[1],Math.max(md37[1] ,Math.max(md38[1], md39[1]) ))) , Math.max(md35[2],Math.max(md36[2],Math.max(md37[2] ,Math.max(md38[2], md39[2]) )))];

const Stability = [Math.max(md40[0],md41[0]) , Math.max(md40[1],md41[1]) , Math.max(md40[2],md41[2])];

const Maintainability_compliance = [md42[0] , md42[1] , md42[2]];

const Fault_Tolerance = [Math.max(md43[0],md44[0]) , Math.max(md43[1],md44[1]) , Math.max(md43[2],md44[2])];

const Recoverability = [md45[0] , md45[1] , md45[2]];

const Reliability_Compliance = [md46[0] , md46[1] , md46[2]];
...
const [Maintainability_complianceFW , setMaintainability_complianceFW] = useState([0.0 ,0.0 ,0.0 ]);
    const handleSelectChangeMaintainability_complianceFW = (event) => {
    const selectedValue = event.target.value.split(',').map(parseFloat);
setMaintainability_complianceFW(selectedValue);
};
...
const Maintainability_complianceDEV = [Maintainability_compliance[0]*Maintainability_complianceFW[0] , Maintainability_compliance[1]*Maintainability_complianceFW[1] , Maintainability_compliance[2]*Maintainability_complianceFW[2] ] ;
...
const integrated = (p+q)/(r+s);
  ...
  return (
	...
	<div className="Question">MD1</div>
...
<div className="factor">
	...
	<div className="Question">MD2</div>
	...
	<div className="Question">MD3</div>
...
<div className="factor">
	...
	<div className="Question">MD4</div>
	...
	<div className="Question">MD5</div>
	...
	<div className="Question">MD6</div>
...
<div className="factor">
	...
	<div className="Question">MD7</div>
...
<div className="factor">
	...
	<div className="Question">MD8</div>
	...
	<div className="Question">MD9</div>
...
<div className="factor">
  ...
  <div className="Question">MD10</div>
  ...
  <div className="Question">MD11</div>
  <label for="md9" className="label"> Fuzzy Rate : </label>
  <select required onChange={(event) =>
  ...
  <div className="Question">MD12</div>
  <label for="md9" className="label"> Fuzzy Rate : </label>
  <select required onChange={(event) =>
  ...
  <div className="Question">MD13</div>
  <label for="md9" className="label"> Fuzzy Rate : </label>
  <select required onChange={(event) =>
...
<div className="Question">MD14</div>
<label for="md9" className="label"> Fuzzy Rate : </label>
<select required onChange={(event) =>
...
<div className="Question">MD15</div>
<label for="md9" className="label"> Fuzzy Rate : </label>
<select required onChange={(event) =>
...
<div className="factor">
	...
	<div className="Question">MD16</div>
	<label for="md9" className="label"> Fuzzy Rate : </label>
	<select required onChange={(event) =>
	...
	<div className="Question">MD17</div>
	<label for="md9" className="label"> Fuzzy Rate : </label>
	<select required onChange={(event) =>
	...
	<div className="Question">MD18</div>
	<label for="md9" className="label"> Fuzzy Rate : </label>
	<select required onChange={(event) =>
	...
	<div className="Question">MD19</div>
	<label for="md9" className="label"> Fuzzy Rate : </label>
	<select required onChange={(event) =>
	...
	<div className="Question">MD20</div>
	<label for="md9" className="label"> Fuzzy Rate : </label>
	<select required onChange={(event) =>
	...
	<div className="factor">
		...
		<div className="Question">MD21</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div className="factor">
		...
		{/* md 22 23 24*/}
    <div className="Question">MD22</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
    ...
    <div className="Question">MD23</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
    ...
    <div className="Question">MD24</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div className="factor">
		...
		{/* md 25 26 */}
    <div className="Question">MD25</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
    ...
    <div className="Question">MD26</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
    ...
    <div className="Question">MD27</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
    ...
    <div className="Question">MD28</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
    ...
    <div className="Question">MD29</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Replace-ability</div>
		{/* 30 */}
		
    <div className="Question">MD30</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Adaptability</div>
		{/* 31 */}

    <div className="Question">MD31</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Install-ability</div>
		{/* 32 */}

    <div className="Question">MD32</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Co-existence</div>
		{/* 33 */}

    <div className="Question">MD33</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Portability Compliance</div>
		{/* 34 */}

		<div className="Question">MD34</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		...
		<div className="Question">MD35</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
		...
		<div className="Question">MD36</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
		...
		<div className="Question">MD37</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
		...
		<div className="Question">MD38</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
		...
		<div className="Question">MD39</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		...
		<div className="Question">MD40</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
		...
		<div className="Question">MD41</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Maintainability Compliance</div>
		{/* 42 */}

		<div className="Question">MD42</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
	...
	<div class="factor">
		<div class="factorTitle">Fault Tolerance</div>
		{/* 43 44 */}

		<div className="Question">MD43</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
		...
		<div className="Question">MD44</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
			handleMdChange('r', 87, event)}>
			<option >Select Option</option>
			<option value="0.0,0.1,0.3">Very Low</option>
			<option value="0.1,0.3,0.5">Low</option>
			<option value="0.3,0.5,0.7">Medium</option>
	...
	<div class="factor">
		...
		<div className="Question">MD45</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
			handleMdChange('r', 89, event)}>
			<option >Select Option</option>
			<option value="0.0,0.1,0.3">Very Low</option>
			<option value="0.1,0.3,0.5">Low</option>
			<option value="0.3,0.5,0.7">Medium</option>
	...
	<div class="factor">
		<div class="factorTitle">Reliability Compliance</div>
		{/* 46 */}

		<div className="Question">MD46</div>
		<label for="md9" className="label"> Fuzzy Rate : </label>
		<select required onChange={(event) =>
			handleMdChange('r', 91, event)}>
			<option >Select Option</option>
			<option value="0.0,0.1,0.3">Very Low</option>
			<option value="0.1,0.3,0.5">Low</option>
			<option value="0.3,0.5,0.7">Medium</option>
	...
	<div className="qualityfactorcontainer">
		...
		<div>
			...
			<div className="qf">Maintainability Compliance</div>

			<div className="qfvalues">
				<div>{Maintainability_compliance[0]} </div>
				<div>{Maintainability_compliance[1]}</div>
				<div>{Maintainability_compliance[2]}</div>
			</div>
		...
		<div>
			...
			<div>
				<select required onChange={handleSelectChangeMaintainability_complianceFW}  >
						<option >Select Option</option>
						<option value="0.0,0.0,0.25">Very Low</option>
						<option value="0.0,0.25,0.50">Low</option>
						<option value="0.25,0.50,0.75">Medium</option>
				...
				<div className="qfvalues1">
					<div>{Maintainability_complianceFW[0]}</div>
					<div>{Maintainability_complianceFW[1]}</div>
					<div>{Maintainability_complianceFW[2]}</div>
				</div>
			</div>
		...
		<div className="headingofqf" >
			...
			<div className="qf">Maintainability_compliance</div>
			<div className="devview">
				<div>{Maintainability_complianceDEV[0]} </div>
				<div>{Maintainability_complianceDEV[1]}</div>
				<div>{Maintainability_complianceDEV[2]}</div>
			</div>
	...
	<div className="devview">
	<div className="resdiv">{max1}</div>
	<div className="resdiv">{max2}</div>
	<div className="resdiv">{max3}</div>
	</div>
